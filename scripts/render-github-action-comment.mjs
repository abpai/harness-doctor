...
const BRAND_HEADER = `<a href="${BRAND_LINK_URL}"><strong>Harness Doctor</strong></a>`;
const BRAND_FOOTER = `Generated by [Harness Doctor](${BRAND_LINK_URL}). Questions? Open an issue at ${BUG_REPORT_URL}.`;

...
import type { EsTreeNode, OxlintRuleSeverity, RuleVisitors } from "oxlint-plugin-harness-doctor";
...
const PLUGIN_NAMESPACE = "harness-doctor";
const RULE_DOCS_BASE_URL = "https://harness.doctor/rules";
...
const buildFlatConfig = (
  ...
  name: `harness-doctor/${configName}`,
  plugins: {},
  rules: { ...ruleSet },
});
...
const eslintPlugin: EslintPlugin = {
  ...
  configs: {
    ...
    all: buildFlatConfig("all", ALL_HARNESS_DOCTOR_RULES),
  },
};

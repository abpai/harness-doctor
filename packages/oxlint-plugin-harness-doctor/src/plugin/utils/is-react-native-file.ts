...
import { getHarnessDoctorStringSetting } from "./get-harness-doctor-setting.js";
...
// given the surrounding `context.settings["harness-doctor"].framework` hint.
//
...
export const isReactNativeFileActive = (context: RuleContext): boolean => {
  ...
  const framework = getHarnessDoctorStringSetting(context.settings, "framework");

...
- [#630](https://github.com/millionco/harness-doctor/pull/630) [`75c1f99`](https://github.com/millionco/harness-doctor/commit/75c1f99e062a8fc3e5e4ba294208dbc56bca5f6f) Thanks [@rayhanadev](https://github.com/rayhanadev)! - Fix `harness-doctor@latest` (and the ESLint/oxlint plugins) crashing before the scan starts with `ERR_MODULE_NOT_FOUND: Cannot find package 'oxc-parser'` under strict package managers like pnpm. The published `oxlint-plugin-harness-doctor/dist/index.js` performs a runtime `import { parseSync } from "oxc-parser"` (cross-file parsing for rules like `no-mutating-reducer-state`) and the build intentionally keeps `oxc-parser` external, but the package only declared it under `devDependencies`, so consumers never had it installed. `oxc-parser` is now a real `dependency`. See [#629](https://github.com/millionco/harness-doctor/issues/629).
...
- Collapse `@harness-doctor/types` and `@harness-doctor/project-info` into `@harness-doctor/core`, simplifying the dependency graph from five workspace packages to three.
...
- [#252](https://github.com/millionco/harness-doctor/pull/252) [`2d90c1c`](https://github.com/millionco/harness-doctor/commit/2d90c1c5ae6d901913a575d40a784058478479ec) - `no-secrets-in-client-code` is scoped to client-reachable bindings.
...
- [#260](https://github.com/millionco/harness-doctor/pull/260) [`b53d873`](https://github.com/millionco/harness-doctor/commit/b53d8730459d2dc469a8f9841def231048c8de7e) - `nextjs-no-side-effect-in-get-handler` stops flagging
  `response.headers.set(...)` and locally-constructed `Map` / `Set` /
...
- [#265](https://github.com/millionco/harness-doctor/pull/265) [`18b7033`](https://github.com/millionco/harness-doctor/commit/18b7033e9e9e6f45a13c1545c8c505922bd4ab8f) - `async-defer-await` no longer reports three legitimate shapes:
...
- [#269](https://github.com/millionco/harness-doctor/pull/269) [`838c7f4`](https://github.com/millionco/harness-doctor/commit/838c7f4174eaa9a7d0aea26d7e618bcc30818315) - `js-length-check-first` detects length guards anywhere earlier in an
...
- [#270](https://github.com/millionco/harness-doctor/pull/270) [`4cbf436`](https://github.com/millionco/harness-doctor/commit/4cbf4368485b91f85701b3eed177282006b69fbc) - `async-parallel` is suppressed in three legitimate contexts: test
...
- [#272](https://github.com/millionco/harness-doctor/pull/272) [`d821ca2`](https://github.com/millionco/harness-doctor/commit/d821ca2a82aa5e0eae0a8de0da32123fc1b89102) - `js-combine-iterations` skips lazy `Iterator` helper chains.
  ...
  eager `Array.prototype` chains. Resolves [#205](https://github.com/millionco/harness-doctor/issues/205).

- [#274](https://github.com/millionco/harness-doctor/pull/274) [`3b7cc7c`](https://github.com/millionco/harness-doctor/commit/3b7cc7c37336b21e4c0292dbb123b762b10a9a87) - `no-prevent-default` is framework-aware. Remix and Next.js
...
`harness-doctor` runtime-dependency fix in beta.4.

## 0.2.0-beta.3

### Patch Changes

- [#253](https://github.com/millionco/harness-doctor/pull/253) [`9783acf`](https://github.com/millionco/harness-doctor/commit/9783acf525a30a4aa69b20bf37b893bb39b362b0) - `no-barrel-import` resolves each `index.{ts,tsx,js,jsx,mjs,cjs}`
...
- [#249](https://github.com/millionco/harness-doctor/pull/249) [`f0198e2`](https://github.com/millionco/harness-doctor/commit/f0198e2f2d9560a15bdb4a78f4a378ca2ac5fcdd) - **Plugin restructured into per-rule modules.** The kitchen-sink
  ...
  [#218](https://github.com/millionco/harness-doctor/pull/218) (initial
  per-file split),
  [#228](https://github.com/millionco/harness-doctor/pull/228) /
  [#230](https://github.com/millionco/harness-doctor/pull/230) /
  [#231](https://github.com/millionco/harness-doctor/pull/231) /
  [#234](https://github.com/millionco/harness-doctor/pull/234)
  (colocate severity / framework / category / requires / examples
  with each `defineRule` call),
  [#229](https://github.com/millionco/harness-doctor/pull/229) (port
  inline `node.type === "X"` checks to `isNodeOfType(node, "X")`),
  [#235](https://github.com/millionco/harness-doctor/pull/235) (drop
  loose `[key: string]: any` escape hatch from `EsTreeNode`),
  [#236](https://github.com/millionco/harness-doctor/pull/236) (split
  `rule-maps.ts` into external-plugin-rules + harness-doctor-rules),
  and [#242](https://github.com/millionco/harness-doctor/pull/242)
...
- [#254](https://github.com/millionco/harness-doctor/pull/254) [`bfaf9c9`](https://github.com/millionco/harness-doctor/commit/bfaf9c9530a9f8761df6e2d69abcf44c1699ff77) - React-19-only rules
...
- [#255](https://github.com/millionco/harness-doctor/pull/255) [`6bc33c8`](https://github.com/millionco/harness-doctor/commit/6bc33c8aab2be7c7254ce9f2a059acbcdad17a58) - `rerender-state-only-in-handlers` /
...
- [#256](https://github.com/millionco/harness-doctor/pull/256) [`0cd9355`](https://github.com/millionco/harness-doctor/commit/0cd93551a4a4600282378125d9aa237ef655835a) - `no-effect-event-handler` narrows what counts as an event handler.
...
- [#257](https://github.com/millionco/harness-doctor/pull/257) [`ffbd20f`](https://github.com/millionco/harness-doctor/commit/ffbd20f3d0ebda2221d2ea93f87342165da90fdb) - Locally-defined functions whose name starts with `use…` (custom

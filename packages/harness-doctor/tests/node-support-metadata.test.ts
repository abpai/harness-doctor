...
const packageManifests: PackageManifestExpectation[] = [
  ...
  {
    packagePath: "packages/eslint-plugin-harness-doctor/package.json",
    shouldDependOnPlatformNodeShared: false,
  },
  {
    packagePath: "packages/oxlint-plugin-harness-doctor/package.json",
    shouldDependOnPlatformNodeShared: false,
  },
  { packagePath: "packages/harness-doctor/package.json", shouldDependOnPlatformNodeShared: true },
];

const packageBuildConfigs = [
  "packages/api/vite.config.ts",
  "packages/core/vite.config.ts",
  "packages/eslint-plugin-harness-doctor/vite.config.ts",
  "packages/oxlint-plugin-harness-doctor/vite.config.ts",
  "packages/harness-doctor/vite.config.ts",
];

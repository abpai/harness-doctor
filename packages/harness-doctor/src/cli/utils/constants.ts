...
// never the programmatic `@harness-doctor/api` library. Overridable at runtime
...
// `harness-doctor@<version>` so they're globally unique within the Sentry org
...
export const SENTRY_RELEASE_PREFIX = "harness-doctor";

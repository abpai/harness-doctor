...
import type { ScoreResult } from "@harness-doctor/core";
...
const BRANDING_LINE = `Harness Doctor ${highlighter.dim("(https://harness.doctor)")}`;
const RAW_BRANDING_LINE = "Harness Doctor (https://harness.doctor)";

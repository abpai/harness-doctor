...
const AGENT_GUIDANCE_LINES = [
  "Treat Harness Doctor diagnostics as starting hypotheses. Read the relevant code before confirming or suppressing each finding.",
  ...
  "Understand the root cause before editing. Fix the underlying code instead of changing harness-doctor config or suppressing rules unless explicitly asked.",
  ...
  "Run `bunx --bun @andypai/harness-doctor@latest --verbose --diff` before and after changes, plus relevant tests after each focused batch.",

...
export interface RuleConfigTarget {
  readonly format: HarnessDoctorConfigFormat;
  ...
  readonly config: HarnessDoctorConfig;
}
...
const writeJsonConfig = (filePath: string, nextConfig: HarnessDoctorConfig): void => {
...
const writePackageJsonConfig = (filePath: string, nextConfig: HarnessDoctorConfig): void => {
